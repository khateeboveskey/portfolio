<template>
  <section id="contact" class="bg-accent dark:bg-gray-800 mx-4 md:mx-8 lg:mx-32 -mb-48 mt-24 md:mt-48 relative flex flex-col md:flex-row gap-6 md:gap-10">
    <div class="flex flex-col justify-between w-full md:flex-1/2 p-6 md:p-12">
      <div>
        <h2 class="text-white text-3xl md:text-4xl font-bold">{{ $t('contact.title') }}</h2>
        <p class="text-white/75 text-base md:text-lg mt-4">{{ $t('contact.subtitle') }}</p>
      </div>
      <div class="space-y-4 mt-8 md:mt-10">
        <h2 class="text-lg text-white font-semibold">{{ $t('footer.connect') }}</h2>
    ...
    <div class="w-full md:flex-1/2 bg-accent-foreground dark:bg-gray-900 p-6 md:p-12">
