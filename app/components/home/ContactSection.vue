<template>
  <section
    id="contact"
    class="bg-accent mx-4 md:mx-8 lg:mx-32 -mb-48 mt-24 md:mt-48 relative flex flex-col md:flex-row gap-6 md:gap-10"
  >
    ...
    <div class="w-full md:flex-1/2 bg-accent-foreground p-6 md:p-12">
      ...
      >
        <label class="flex flex-col text-white">
          ...
          />
          <span v-if="!isEmailValid && email" class="text-accent text-sm mt-1"
        ...
        <label class="flex flex-col text-white">
          ...
          <textarea
            ...
            :class="[
              'mt-2 p-2 bg-accent-background/10 border border-accent-background/20 text-white focus:outline-none focus:border-accent-background h-32 w-full',
