<template>
  <a
    :href="props.to"
    :class="borderHoverEffectClasses"
    class="relative inline-block w-full border-b pb-2.5 transition-all md:border-0 md:border-transparent md:pb-0 md:hover:border-transparent"
  >
    <slot />
  </a>
</template>
